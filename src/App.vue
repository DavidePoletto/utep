...
.text-2xl { font-size: 1.5rem; line-height: 1.33; }
...
/* TRANSIZIONI SEMPLICI - Solo fade veloce */
.fade-enter-active {
...
.badge-outline { background: transparent; border: 1px solid var(--color-neutral-light); color: var(--gray-600); }
